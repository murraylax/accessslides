...
\begin{slide}{Include Graphics with Alt Text}
  ...
  The \texttt{includegraphics} environment is redefined to require alternative text for accessibility.
\end{slide}
...
\begin{slide}{Decorative Graphics with \texttt{decographics}}
  ...
  Use \texttt{decographics} instead of \texttt{includegraphics} for purely decorative images. They do not require alt text and the images are ignored by assistive technologies.
\end{slide}
...
\begin{slide}{Simple With Minimal Features}
  \vspace*{-0.25in}
  \begin{itemize}
    \item This document class is not nearly as full-featured as \href{https://latex-beamer.com/}{Beamer}.
